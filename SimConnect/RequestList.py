...
class AircraftRequests():
	...
	class __AircraftLightsData(RequestHelper):
		list = {
			...
			"LIGHT_PEDESTRAL_POWER_SETTING": ["Pedestal light power setting", b'LIGHT PEDESTRAL POWER SETTING', b'Percent', 'N'],
			"LIGHT_GLARESHIELD_POWER_SETTING": ["Glareshield light power setting", b'LIGHT GLARESHIELD POWER SETTING', b'Percent', 'N'],
