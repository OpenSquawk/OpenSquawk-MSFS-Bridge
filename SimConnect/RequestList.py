...
class AircraftRequests():
	...
	class __AircraftLightsData(RequestHelper):
		list = {
			...
			"LIGHT_BEACON_POWER_SETTING": ["Beacon light power setting", b'LIGHT BEACON POWER SETTING', b'Percent', 'N'],
			"LIGHT_STROBE_POWER_SETTING": ["Strobe light power setting", b'LIGHT STROBE POWER SETTING', b'Percent', 'N'],
			"LIGHT_NAV_POWER_SETTING": ["Navigation light power setting", b'LIGHT NAV POWER SETTING', b'Percent', 'N'],
			"LIGHT_LOGO_POWER_SETTING": ["Logo light power setting", b'LIGHT LOGO POWER SETTING', b'Percent', 'N'],
			"LIGHT_LANDING_POWER_SETTING": ["Landing light power setting", b'LIGHT LANDING POWER SETTING', b'Percent', 'N'],
			"LIGHT_TAXI_POWER_SETTING": ["Taxi light power setting", b'LIGHT TAXI POWER SETTING', b'Percent', 'N'],
			"LIGHT_RECOGNITION_POWER_SETTING": ["Recognition light power setting", b'LIGHT RECOGNITION POWER SETTING', b'Percent', 'N'],
			"LIGHT_WING_POWER_SETTING": ["Wing light power setting", b'LIGHT WING POWER SETTING', b'Percent', 'N'],
			"LIGHT_PANEL_POWER_SETTING": ["Panel light power setting", b'LIGHT PANEL POWER SETTING', b'Percent', 'N'],
			...
			"LIGHT_CABIN_POWER_SETTING": ["Cabin light power setting", b'LIGHT CABIN POWER SETTING', b'Percent', 'N'],
	...
	class __AircraftMiscellaneousData(RequestHelper):
		list = {
			...
			"BLEED_AIR_APU": ["True if APU bleed air is on", b'BLEED AIR APU', b'Bool', 'N'],
			...
			"APU_SWITCH": ["True if the APU switch is on", b'APU SWITCH', b'Bool', 'N'],
